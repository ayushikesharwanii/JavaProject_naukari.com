...
<html>
                     ...
                     <center><b style="padding:5%;color:white; font-size:40px; text-align: center;">Sign<b style="color:#faaa5d;;">Up 
                      ...
                      <div class="col-sm-12 signup">
                          ...
                          <div class="col-sm-7 form">
                              ...
                              <div class="row">
                <form action="upcode" enctype="multipart/form-data" method="post">
  ...
  <input type="text" name="experience" class="form-control" placeholder="Experience" aria-describedby="basic-addon1">
              ...
              <div class="row">
                   <div class="col-sm-6">
                       ...
                       <span class="txt">FILE UPLOAD</span>
                       <input type="file" name="pic" value="UPLOAD FILE" class="form-control">

            </div>
                  <div class="col-sm-6">
                  <span class="txt">JOB CATEGORY</span>
                       
                           <select name="jcategory" class="form-control">
                               <option>--Select qualification--</option>
                               <option>Hr</option>
                  ...
                  <textarea class="form-control" name="address" placehoder="address"> </textarea>
