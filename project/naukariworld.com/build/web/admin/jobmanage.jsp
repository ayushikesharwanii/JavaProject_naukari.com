<%-- 
    Document   : jobmanage
    Created on : Aug 5, 2019, 12:39:40 PM
    Author     : Ayushi
--%>
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-12 head1">
                        <div class="text-center"> ADDJOBS MANAGEMENT
                        ...
                        <tr>
                            ...
                            <tr>
                               ...
                               <td><%out.print(rs.getString(7));%></td>
                                ...
                                <td><a href="code/jdel.jsp?name=<%out.print(rs.getString(1));%>" style='color:pink;'><span class='fa fa-trash'></span></a></td>
                                </tr>
                                <%
                                i=i+1;
